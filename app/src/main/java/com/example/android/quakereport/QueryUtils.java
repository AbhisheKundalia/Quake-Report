...
*/
     ...
     */
    private QueryUtils(String vSAMPLE_JSON_RESPONSE) {
        SAMPLE_JSON_RESPONSE = vSAMPLE_JSON_RESPONSE;
    }
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        //Perform HTTP request for the URL and back Json Response back
        try {
            jsonResponse = makeHttpRequest(url);

        } catch (IOException e) {
            Log.e(LOG_TAG, "Error retrieving Json Response from makeHttpRequest", e);
        }
        return extractEarthquakes(jsonResponse);
    }

    /**
     * TO create Url out of string passed as argument
     *
     * @param requestUrl is the input in string datatype for the URL
     * @return Url in URL datatype
     */
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                Log.e(LOG_TAG, "Response code Failes as:" + urlConnection.getResponseCode());
            }
        } catch (IOException e) {
            Log.e(LOG_TAG, "Error recieving Json response", e);
        } finally {
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String JSONResponse) {
        ...
        try {
            ...
            // To read through all the earthquake details
            for (int i = 0; i < features.length(); i++) {
                ...
                //add the extracted data to earthquake arraylist
